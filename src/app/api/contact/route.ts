      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px -10px rgba(30,58,95,.15)">
        ...
        <tr><td style="padding:32px 40px">
          <table width="100%" cellpadding="0" cellspacing="0" style="border-radius:8px;overflow:hidden;border:1px solid #e8e4db">
            ...
            <tr><td style="padding:10px 16px;color:#6b7280;font-size:13px;background:#f7f5f0;border-bottom:1px solid #e8e4db">E-mail</td><td style="padding:10px 16px;font-size:14px;border-bottom:1px solid #e8e4db"><a href="mailto:${escape(email)}" style="color:#00a66e">${escape(email)}</a></td></tr>
          ...
          <h2 style="margin:28px 0 12px;font-size:15px;color:#0b3d2e;text-transform:uppercase;letter-spacing:.1em">Bericht</h2>
    ...
    <tr><td align="center">
      <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px -10px rgba(30,58,95,.15)">
        ...
        <tr><td style="padding:32px 40px;color:#1a1a1a;font-size:15px;line-height:1.6">
          ...
          <p>Dringend? Bel of app ons gerust op <a href="tel:+31658866070" style="color:#00a66e">+31 6 58 86 60 70</a>.</p>
